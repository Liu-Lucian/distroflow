#!/bin/bash
# Instagram智能营销系统 - 一键启动脚本

echo "======================================================================"
echo "📸 Instagram Smart Marketing Campaign"
echo "======================================================================"
echo ""

# 检查是否在正确的目录
if [ ! -f "run_instagram_campaign_optimized.py" ]; then
...
if [ ! -f "platforms_auth.json" ]; then
    ...
    echo '{'
    echo '  "instagram": {'
    echo '    "sessionid": "your_instagram_sessionid_here"'
    echo '  }'
    echo '}'
    echo ""
    exit 1
...
echo "✅ Instagram 认证文件已找到"
echo ""

# 显示配置
echo "📊 运行配置:"
echo "  - 关键词: job interview tips, interview preparation, career advice"
...
echo ""
echo "📋 查看结果:"
echo "  - 合格用户: instagram_qualified_users.json"
echo "  - 缓存: cache/instagram_analyzed_comments.json"
echo ""
echo "💡 提示:"
echo "  - 第二次运行相同关键词将使用缓存 (成本 = \$0)"
echo "  - 修改关键词请编辑 run_instagram_campaign_optimized.py"
